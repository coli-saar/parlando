---
title: "Parlando: Unterlage zur datenschutzrechtlichen Plattformbewertung"
---
...
7. Die Aufgabe kann eine Tastaturkommunikation bereitstellen. Bei Mensch–Mensch-Sprache übermittelt Parlando die Live-Stimme und lässt beide Seiten durch Speechmatics transkribieren. Bei Mensch–Agent-Sprache wird die menschliche Stimme transkribiert und die gespeicherte Agentenantwort durch ElevenLabs vorgelesen.
...
- optional eine vom Spiel bereitgestellte Tastaturkommunikation,
- Mensch–Mensch-Sprache mit Echtzeittranskription durch Speechmatics,
- Mensch–Agent-Sprache mit Speechmatics und Sprachausgabe der Agentenantwort durch ElevenLabs,
...
```text
Browser A ──verschlüsselt──> selbst gehosteter Parlando-Server ──> lokale Datenbank
   ▲                              │                                  │
...
| Tastatur-Chat | gesendete Nachrichten werden gespeichert, wenn das Spiel diese Kommunikationsform bereitstellt | ermöglicht die Analyse des Zusammenhangs zwischen sprachlicher Koordination und Spielverlauf |
| Finale Sprachtranskripte | finale Transkripte mit Sprecher und Äußerungszeiten werden in Sprachbedingungen gespeichert | macht gesprochene Kommunikation für Dialoganalysen zugänglich, ohne Roh-Audio zu archivieren |
...
| Erklärungsnachweis | Entscheidungen, Zeitpunkt, Informationsversion und -URL | belegt, welche konfigurierte Information referenziert und welche Erklärung abgegeben wurde |
...
Parlando zeigt vor Beginn eine versionierte Teilnehmerinformation an beziehungsweise verlinkt sie dauerhaft. Mit der Erklärung speichert Parlando:

- die Versionskennung der Teilnehmerinformation,
- die Entscheidung zu jedem Consent-Item und
- den Zeitpunkt der Erklärung.

Eine Textänderung erzeugt eine neue Version. Der Eintritt wird erst nach erfolgreicher Speicherung aller erforderlichen Entscheidungen ermöglicht. Parlando archiviert den Inhalt der verlinkten Informationsseite nicht selbst. Die verantwortliche Stelle archiviert deshalb die tatsächlich veröffentlichte Seite unter der gespeicherten Versionskennung; Anlage C enthält diese Fassung für die Plattformprüfung.
...
Im Adminbereich steht „Delete participant data“ zur Verfügung. Vor der Ausführung zeigt die Funktion die experimentbezogene Teilnehmerkennung und die betroffenen gemeinsamen Sitzungen. Nach Bestätigung löscht Parlando diese Sitzungen einschließlich der Beiträge beider Rollen und anschließend den Teilnehmerdatensatz einschließlich Rekrutierungszuordnung und Erklärungsnachweisen. Laufende Sitzungen müssen vorher beendet sein.

Die Funktion löscht den vollständigen gemeinsamen Verlauf, weil die Beiträge beider Rollen in einer Dialogsitzung voneinander abhängen. Die konkrete Reaktion auf Widerruf, Widerspruch oder Löschverlangen richtet sich nach der lokal gewählten Rechtsgrundlage und den anwendbaren Forschungsausnahmen.
...
- Zugriff der Teilnehmeranwendung nur von konfigurierten Studienadressen,
...
| Informationsnachweis | gespeicherte Version und URL, archivierte Teilnehmerinformation, Einzelentscheidungen und Zeitpunkt einer Beispielerklärung |
