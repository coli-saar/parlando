...
This chapter documents the communication interfaces that Parlando 0.4.2 supports as complete study
...
Parlando 0.4.2 supports the following interfaces:
...
There is no generic chat widget in the Parlando 0.4.2 React package. The client package supports
...
results. Parlando 0.4.2 neither displays nor stores those partial hypotheses. Only final utterances
...
Parlando 0.4.2 includes Speechmatics transcription and ElevenLabs synthesis, stores neither raw
