...
- Fixed Prolific study validation to accept the experiment-specific participant URL generated by
  the dashboard (`/e/<experiment-id>/`) instead of requiring the nonexistent `/participant` path.
